    ...
    <main className="flex min-h-screen flex-col w-screen items-center justify-center px-10 py-10 md:py-20 bg-slate-800">
      <div  className="rounded overflow-hidden w-full h-full md:w-4/5 xl:w-2/3 flex flex-grow">
        <div className="hidden md:flex bg-slate-400 text-black px-5 xl:px-10 justify-center gap-4 lg:gap-5 flex-col max-w-[45%]">
          ...
          <p className="xl:text-lg">Please sign in to create your learner's license.</p>
        </div>

        <div className="bg-white flex-grow flex justify-center flex-col px-5 py-8 xl:px-10">
          ...
          <a href='#' className='text-sm text-slate-800 mt-3'>Forgot Password?</a>
          <p className='text-center mt-5' >Using first Time? <a href="/signup" className='font-bold'>Sign up.</a></p>
        </div>
      </div>
    </main>
  );

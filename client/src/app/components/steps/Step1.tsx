...
const Step1 = () => {
    return (
        <>
            <p className='opacity-50 text-sm mb-2'>Step 1 of 6</p>
            <p className='text-xl font-semibold'>Provide You details</p>

            <form action="" className='mt-6 ml-2'>

                <div className="mb-5 flex items-center">
                    <label htmlFor="name" className='w-32 lg:w-44 inline-block'>Name: </label>
                    <input type="text" placeholder='Name' className='rounded px-3 py-1 bg-slate-600 w-full max-w-56' />
                </div>

                <div className='mb-5 flex items-center'>
                    <label htmlFor="" className='w-32 lg:w-44'>State: </label>
                ...
                <div className='mb-5 flex items-center'>
                    <label htmlFor="" className='w-32 lg:w-44'>Category: </label>
                    <div className='bg-slate-600 pr-1 rounded h-fit'>
                ...
                <div className='mb-5 flex items-center'>
                    <label htmlFor="" className='w-32 lg:w-44'>Gender: </label>
                    <div className='bg-slate-600 pr-1 rounded h-fit'>
                ...
                <div className="mb-5 flex items-center">
                    <label htmlFor="name" className='w-32 lg:w-44 inline-block'>Address Line 1: </label>
                    <input type='text' placeholder='Address Line 1' className='rounded px-3 py-1 bg-slate-600 w-full max-w-52' />
                </div>

                <div className="mb-5 flex items-center">
                    <label htmlFor="name" className='w-32 lg:w-44 inline-block'>Address Line 2: </label>
                    <input type='text' placeholder='Address Line 2' className='rounded px-3 py-1 bg-slate-600 w-full max-w-52' />
                </div>

                <div className="mb-2 flex items-center">
                    <label htmlFor="name" className='w-32 lg:w-44 inline-block'>Pincode: </label>
